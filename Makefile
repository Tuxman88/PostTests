#############################################################################
# Makefile for building: PruebaPOST
# Generated by qmake (3.0) (Qt 5.4.1)
# Project:  PruebaPOST.pro
# Template: app
# Command: /bin/qmake-qt5 -o Makefile PruebaPOST.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PruebaPOST1.0.0
DISTDIR = /mnt/Cosas/Proyectos/PruebaPOST/.tmp/PruebaPOST1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: PruebaPOST.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib64/qt5/mkspecs/features/exclusive_builds_post.prf \
	...
	$(QMAKE) -o Makefile PruebaPOST.pro
