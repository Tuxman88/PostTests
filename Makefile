#############################################################################
# Makefile for building: PostTests
# Generated by qmake (3.0) (Qt 5.4.1)
# Project:  PostTests.pro
# Template: app
# Command: /bin/qmake-qt5 -o Makefile PostTests.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PostTests1.0.0
DISTDIR = /mnt/Cosas/Proyectos/PostTests/.tmp/PostTests1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: PostTests.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile PostTests.pro
